...
CREATE TABLE orderdetails (
	...
	CONSTRAINT orderdetails_fk FOREIGN KEY (orderid) REFERENCES public.orders(orderid),
	CONSTRAINT orderdetails_fk_1 FOREIGN KEY (productid) REFERENCES public.products(productid)
);
DROP TABLE IF EXISTS productsuppl;
CREATE TABLE productsuppl (
	productid int4 NOT NULL,
	supplierid int4 NOT NULL,
	qty int4 NULL,
	...
	CONSTRAINT productsuppl_fk FOREIGN KEY (productid) REFERENCES public.products(productid),
	CONSTRAINT productsuppl_fk_1 FOREIGN KEY (supplierid) REFERENCES public.suppliers(supplierid)
);